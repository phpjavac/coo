...
class Colours {
  ...
  static const Color dark_text_gray = Color(0xFFFFFFFF);
  ...
  static const Color unselected_item_color = Color(0xFFFFFFFF);
  static const Color dark_unselected_item_color = Color(0xFFFFFFFF);
